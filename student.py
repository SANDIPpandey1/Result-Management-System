...
class studentClass:
    ...
    #=========column2=======
        ...
        # lbl_pin = Label(self.root, text="pin", font=("goudy old style", 15, "bold"), bg="white").place(x=360, y=220)
    ...
    #=======Entry=======
        ...
        txt_city=Entry(self.root, textvariable=self.var_city, font=("goudy old style", 15, "bold"), bg="lightyellow").place(x=480, y=220, width=200)
    ...
    #=======Content=======
        ...
        self.CourseTable = ttk.Treeview(self.C_Frame, columns=("roll", "name", "email", "gender", "dob", "contact", "admission","Course", "state", "City", "Address"), yscrollcommand=scrolly.set, xscrollcommand=scrollx.set)
...
#clear
    ...
    def delete(self):
        ...
        cur=con.cursor()
        try:
            if self.var_roll.get()=="" :messagebox.showerror("Error", "roll no is Empty", parent=self.root)
            else:
    ...
    def add(self):
            ...
            try:
                if self.var_roll.get()=="":
                    ...
                    cur.execute("Select * from student where roll=?",(self.var_course.get(),))
                    row=cur.fetchone()
                    if row!=None:
    ...
    def update(self):
        ...
        try:
            if self.var_roll.get()=="" :
                messagebox.showerror("Error", "Roll is Empty", parent=self.root)
            else:
                cur.execute("Select * from student where roll=?",(self.var_roll.get(),))
                row=cur.fetchone()
            if row==None:
